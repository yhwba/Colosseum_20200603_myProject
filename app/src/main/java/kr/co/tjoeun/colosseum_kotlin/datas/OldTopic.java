...
public class OldTopic implements Serializable {
...
//    private int mySideId;
    ...
    public static OldTopic getTopicFromJson(JSONObject jsonObject) {
        OldTopic oldTopic = new OldTopic();
        try {
            oldTopic.id = jsonObject.getInt("id");
            oldTopic.title = jsonObject.getString("title");
            oldTopic.imageUrl = jsonObject.getString("img_url");
...
//        }
    ...
    public OldTopic(int id, String title, String imageUrl) {
        this.id = id;
        this.title = title;
